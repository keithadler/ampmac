...
check "presets lists seventeen" '[ "$("$BIN" presets | wc -l | tr -d " ")" = 17 ]'
...
for p in "Clean Kit" "Tight Pop" "Rock Room" "Garage" "Arena" "Dry Punch" "Lo-fi" "Levee Stairwell" "In the Air" "Motown" "Abbey Road" "Nevermind" "Boom Bap" "Blue Note" "Tight Metal" "Dead 70s" "Disco"; do
