...
- A new preset goes in `Presets.swift` with a name people will recognise by ear and a sentence in Help saying what it is for. A new stage in the chain goes in `DSP.swift` with a test that shows it doing its one thing.
